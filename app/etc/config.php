...
Disallow: /*SID=
            ...
            'currency' => [
                'options' => [
                    'allow' => 'BRL,GBP,BND,BGN,BUK,BIF,XPF,KHR,CAD,CVE,KYD,CLP,CNY,COP,KMF,CDF,CRC,HRK,CUP,CZK,DKK,DJF,DOP,XCD,EGP,GQE,ERN,EEK,ETB,EUR,FKP,FJD,GMD,GEK,GEL,GHS,GIP,GTQ,GNF,GYD,HTG,HNL,HKD,HUF,ISK,INR,IDR,IRR,IQD,ILS,JMD,JPY,JOD,KZT,KES,KWD,KGS,LAK,LVL,LBP,LSL,LRD,LYD,LTL,MOP,MKD,MGA,MWK,MYR,MVR,MRO,MUR,MXN,MDL,MNT,MAD,MZN,MMK,NAD,NPR,ANG,TWD,NZD,NIC,NGN,KPW,NOK,OMR,PKR,PAB,PGK,PYG,PEN,PHP,PLN,QAR,RHD,RON,ROL,RUB,RWF,SVC,WST,SAR,RSD,SCR,SLL,SGD,SKK,SBD,SOS,ZAR,KRW,LKR,SHP,SDG,SRD,SZL,SEK,CHF,SYP,STD,TJS,TZS,THB,TOP,TTD,TND,TRY,TRL,TMM,USD',
                    'base' => 'BRL',
                    'default' => 'BRL',
                ],
                'fixerio' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'carriers' => [
                ...
                'frenetshipping' => [
                    ...
                    'active' => '1',
                    'title' => 'Envio Frenet',
                    'token' => '0:3:BkTzm4woA9a3/56REpEwZ7CHsN3/39JisYgjlCaQmYYRTA+Cf91Refzogekt+Dk4fbUx41XWJbj/FGBBQLDzeQ==',
                    'use_default' => '1',
                    'default_height' => '2',
                    'default_length' => '16',
                    'default_width' => '11',
                    ...
                    'specificcountry' => null,
                    'sort_order' => '90',
                    'specificerrmsg' => 'O método de envio Frenet não está disponível.',
                    'sallowspecific' => '0',
            ...
            'shipping' => [
                'origin' => [
                    ...
                    'region_id' => '508',
                    'city' => 'Campinas',
                    'street_line1' => 'Rua Joaquim Theodoro Teixeira de Souza',
                    'street_line2' => null,
                ],
                'shipping_policy' => [
            ...
            'proofo' => [
                ...
                'webhook' => [
                    'enabled_webhooks' => 'orders_hook,cart_hook,signup_hook',
                    'bundle_as_multiple' => '0',
                ],
            ],
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'VCEQEUCEMt7uUbWa83SSd3mhee7UPAfi',
            ...
            'yotpo' => [
                ...
                'sync_settings' => [
                    ...
                    'orders_sync_start_date' => '2021-01-04',
                ],
                'module_info' => [
                    'yotpo_installation_date' => '2021-01-04',
                ],
            ],
            ...
            'twofactorauth' => [
                'duo' => [
                    'application_key' => 'uru4QAxXlJFgWnUzvbJOFPYY0YGrCBbsHCwvEx8wYIm2xSrxyEc1V84Lbsm3G49r',
                ],
            ],
        ],
        'stores' => [
            ...
            'pt' => [
                ...
                'design' => [
                    'header' => [
                        'logo_src' => 'stores/2/Clofem_1.jpg',
                    ],
                ],
            ],
            'en' => [
                ...
                'design' => [
                    'header' => [
                        'logo_src' => 'stores/3/Clofem_1.jpg',
                    ],
                ],
                'carriers' => [
                    'frenetshipping' => [
                        ...
                        'show_shipping_forecast' => '1',
                        'shipping_forecast_message' => '{{d}} day(s)',
                    ],
                ],
            ],
            'store_view_1' => [
                'web' => [
                    'default' => [
                        'cms_home_page' => 'home-colecionaveis',
                    ],
                ],
                'design' => [
                    'header' => [
                        'logo_src' => 'stores/1/Mundo_Geek.jpg',
                    ],
                ],
            ],
        ],
        'websites' => [
            ...
            'website_2' => [
                ...
                'design' => [
                    'header' => [
                        'logo_src' => 'websites/2/Clofem.jpg',
                    ],
                    'theme' => [
            ...
            'website_1' => [
                'general' => [
                    ...
                    'store_information' => [
                        ...
                        'postcode' => '18117-674',
                        'city' => 'São Paulo',
                        'street_line1' => 'Rua Vereador Georgino Marques Dias',
                    ],
                ],
                'currency' => [
                    'options' => [
                ...
                'design' => [
                    ...
                    'header' => [
                        'logo_src' => 'websites/1/Mundo_Geek.jpg',
                    ],
                ],
            ],
        ],
